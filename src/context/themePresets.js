...
export const DEFAULT_THEME_PRESETS = {
  VitniNordic: {
    ...
    textDim: '#5f6c85',
    accentMana: '#477691',
    accentHighlight: '#4e90a3',
    statusActive: '#4C7864',
    fontMono: "'IBM Plex Mono', monospace",
    fontSans: "'IBM Plex Sans', sans-serif",
    black: '#142126', red: '#914149', green: '#1f3624', yellow: '#ba9922',
    blue: '#305982', magenta: '#964187', cyan: '#4e90a3', white: '#f2fcff',
    brightBlack: '#262b35', brightRed: '#a13c2a', brightGreen: '#31573a', brightYellow: '#deca3e',
    brightBlue: '#81A1C1', brightMagenta: '#c99fc1', brightCyan: '#74dbd9', brightWhite: '#ECEFF4',
  },
  Dracula: {
    name: 'Dracula',
    bgEarth: '#282a36',
